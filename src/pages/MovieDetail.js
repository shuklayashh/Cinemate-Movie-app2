...
export const MovieDetail = () => {
  ...
  const [movie,movieData] = useState({});
  ...
  useEffect(() => {
    async function fetchMovie() {
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=81ad184ef3feb48d16ad28b8619b2093`);
  ...
  return (
    <main>
      <section className = "flex justify-around flex-wrap other:justify-evenly">
